...
with open("configs/wgan_config.yaml") as f:
    ...
    fixed_z = create_noise(batch_size, latent_dim, latent_distribution).to(device)


    generator = make_generator_network_wgan(latent_dim, n_channel_scaling_factor).to(device)
